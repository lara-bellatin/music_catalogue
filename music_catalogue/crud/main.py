...
from music_catalogue.models import UnifiedSearchResult, _parse_list, EntityType

async def unified_search(query: str, entity_types: Optional[List[EntityType]] = None, limit: Optional[int] = 20) -> List[UnifiedSearchResult]:
