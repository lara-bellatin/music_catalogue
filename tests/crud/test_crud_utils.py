"""Unit tests for CRUD utility validation helpers."""

import uuid

import pytest

from music_catalogue.crud.utils import (
...
class TestValidateUUID:
    ...
    def test_invalid_uuid_raises_validation_error(self):
        """Malformed UUID strings raise ValidationError."""
...
class TestValidateStartAndEndYears:
    ...
    def test_invalid_year_value_raises_validation_error(self):
        ...
        with pytest.raises(ValidationError):
            validate_start_and_end_years(0, 10)
